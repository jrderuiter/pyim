...
from pyim.common.util import repeat_list, flatten_list
...
class KcrbmAnnotator(Annotator):
    ...
    def _convert_to_kcrbm_frame(self, insertions):
    ...
    def _parse_gene_result(self, result):
    ...
    def _parse_transcript_result(self, result):
        result = result.ix[result['ensid'].astype(str) != 'NA']
